...
public class MonsterActionSuggestion {
	...
	private int[] infoMessageParams; 		// array de parámetros numéricos para utilizar en el mensaje de ayuda. (la clave del mensaje se obtiene del tipo de tarea).
	...
	private int[] targetValueMessageParams; // array de parámetros numéricos para utilizar en el mensaje informativo del "target value".
	...
	public MonsterActionSuggestion(MonsterActionType monsterActionType,
            ...
            String infoMessageKey, int[] infoMessageParams, int targetValue,
            int targetValueIncreasePerTurn, String targetValueMessageKey,
            int[] targetValueMessageParams) {
	...
	public int[] getInfoMessageParams() { return infoMessageParams; }
	...
	public int[] getTargetValueMessageParams() { return targetValueMessageParams; }
